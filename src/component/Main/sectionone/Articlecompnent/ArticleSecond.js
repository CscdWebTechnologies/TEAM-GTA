    ...
    render() { 
        return ( 
           ...
           <div  className="middle1" >
            ...
            <h6  style={{color:"rgb(188, 181, 181)"}} > 
             ...
             Start buying & selling
              ...
              <div className="row">
                ...
                <button className="btn btn-primary">
                   ...
                   <div className= "col-md-6"> 
                   <img style= {{width:"100%" , marginLeft:"14px"}} src="https://assets.coinbase.com/assets/earn-upsell-desktop.dad0f473399e16fa8c176a9599c883ea.webp"/>
                   </div>
              </div>
